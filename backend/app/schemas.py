...
class NewStaffMember(BaseModel):
    ...
    max_caseload: int = 15
    requested_by: int  # staff ID of the person making the request


class GrantPermissionPayload(BaseModel):
    permission: str   # "can_manage_staff" or "can_handle_high_risk" or "is_on_call"
    value: bool = True
    granted_by: int   # staff ID of the person granting
